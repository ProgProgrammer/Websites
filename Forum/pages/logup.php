        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content rounded-4 shadow">
                ...
                <div class="modal-header p-5 pb-4 border-bottom-0">
                    <h1 class="fw-bold mb-0 fs-2">Войдите</h1>
                ...
                <div class="modal-body p-5 pt-0">
                    <form class="form-log-js">
                        ...
                        <p class="display-none form-error-text-js">Логин/пароль введен/ы неверно</p>
                        <button class="w-100 mb-2 btn btn-lg rounded-3 btn-primary button-logup-js" type="submit">Войти</button>
                        <a href="registration.php" class="w-100 mb-2 btn btn-lg rounded-3 btn-primary">Зарегистрироваться</a>
                    </form>
                </div>
